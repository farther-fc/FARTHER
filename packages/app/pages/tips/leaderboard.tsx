  ...
  return (
    <Container variant="page">
      ...
      <p className="text-muted mb-6">
        ...
        (month). The current rewards pool is{" "}
        {numeral(TIPPER_REWARDS_POOL).format("0,0a")} $farther, which is
        distributed pro rata to tippers with a postive tipper score at the end
        of the month.
      </p>
      <Leaderboard />
    </Container>
