...
export interface FartherAirdropInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "END_TIME"
      | "MERKLE_ROOT"
...
export interface FartherAirdrop extends BaseContract {
  connect(runner?: ContractRunner | null): FartherAirdrop;
  waitForDeployment(): Promise<this>;

  interface: FartherAirdropInterface;
