 ...
 */
export const NEXT_AIRDROP_START_TIME = new Date("2024-09-01T00:00:00Z");
...
export const INITIAL_ELIGIBLE_TIPPERS = 100;

export const TIPPER_REQUIRED_FARTHER_BALANCE =
  ENVIRONMENT === "development" ? 500_000 : 100_000;

export const ADDITIONAL_TIPPERS_INCREMENT = 5;

export const REQUIRED_DOLLAR_VALUE_PER_TIPPER = 25;
...
export const cronSchedules = {
  TIPPEE_OPENRANK_SYNC: "0 2,8,14,20 * * *",
  // 1 hour after openrank snapshot
  CREATE_TIPPER_SCORES: "0 3,9,15,21 * * *",
